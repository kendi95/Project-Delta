...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		...
		if(objDto.getId() == null) {
			...
			Cliente cliente = new Cliente(null, objDto.getNome(), objDto.getEmail(), objDto.getSexo(), objDto.getCpf(), endereco, telefone);
			...
			Cliente cliente = new Cliente(objDto.getId(), objDto.getNome(), objDto.getEmail(), objDto.getSexo(), objDto.getCpf(), endereco, telefone);
	...
	public ClienteNewDTO toClienteNewDTO(Cliente obj) {
		...
		ClienteNewDTO objDto = new ClienteNewDTO(obj.getId(), obj.getNome(), obj.getEmail(), obj.getSexo(), obj.getCpf(), 
